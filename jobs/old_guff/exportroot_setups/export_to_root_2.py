...
if __name__ == '__main__':
    ...
    options_all['out_path'] = "/state/partition1/awilkins/ndfdT10UVZvalid_Zdoublecols14latest_Ugeomservice1biasmu_Vgeomservice2biasmu_fdtruefdpredndin_valid4202_500-1000.root"

    options_all['start_i'] = 500  # -1 for all
    options_all['end_i'] = 1000 # -1 for all
