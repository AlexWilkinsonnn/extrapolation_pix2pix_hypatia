...
if __name__ == '__main__':
    options = {
        'dataroot' : '/state/partition1/awilkins/nd_fd_radi_1-8_vtxaligned_noped_morechannels_fddriftfixed',
        'dataroot_shared_disk' : '/share/gpu3/awilkins/nd_fd_radi_1-8_vtxaligned_noped_morechannels_fddriftfixed', # Can be /share/gpu{0,1,2,3}
        'unaligned' : True,
        ...
        'name' : "nd_fd_radi_1-8_vtxaligned_noped_morechannels_fddriftfixed_1",
        'gpu_ids' : [0],
